...
L'output est erroné ! Comment pouvons-nous l'améliorer grâce à la self-consistency ? Essayons. Nous utiliserons les exemples few-shot de Wang et al. 2022 (Tableau 17) :
