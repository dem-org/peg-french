# Générer des connaissances à utiliser dans le prompt
...
En utilisant une idée similaire, le modèle peut-il également être utilisé pour générer des connaissances avant de faire une prédiction ? C'est ce que tente de faire l'article de [Liu et al. 2022](https://arxiv.org/pdf/2110.08387.pdf) -- générer des connaissances à utiliser dans le cadre du prompt. Plus particulièrement, dans quelle mesure cela est-il utile pour des tâches telles que le raisonnement de bon sens ?
